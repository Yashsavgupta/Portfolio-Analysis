      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="mb-8 flex flex-col items-center gap-3 text-center">
          <svg width="40" height="40" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="36" height="36" rx="9" fill="url(#signup-lm-grad)" />
            ...
            <defs>
              <linearGradient id="signup-lm-grad" x1="0" y1="0" x2="36" y2="36" gradientUnits="userSpaceOnUse">
          ...
          <p className="text-sm text-slate-400">Start tracking and analyzing your investment portfolio.</p>
        </div>
